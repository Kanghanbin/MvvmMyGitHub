...
class ReposTypeConverter {
    @TypeConverter
    fun storeLicense2String(license: License?): String = license.toJson()
    @TypeConverter
    fun storeString2License(value: String): License = value.fromJson()
    @TypeConverter
    fun storeOwner2String(owner: Owner):String = owner.toJson()
    @TypeConverter
    fun storeString2Owner(value: String): Owner = value.fromJson()
